...
function MainNav() {
  return (
    <nav>
      <NavList>
        <li>
          <StyledNavLink to="/dashboard"><HiOutlineHome/> Home</StyledNavLink>
        </li>
        <li>
          <StyledNavLink to="/bookings"><HiOutlineCalendarDays/>Booking</StyledNavLink>
        </li>
        <li>
        ...
        <li>
          <StyledNavLink to="/settings"><MdOutlineSettings/>Sittings</StyledNavLink>
        </li>
      </NavList>
    </nav>
  )
